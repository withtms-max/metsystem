  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="inline-flex items-center gap-1.5 h-9 px-4 rounded-lg bg-[var(--line)] hover:bg-[var(--line-strong)] text-[var(--text-900)] text-[13px] font-semibold transition">
        <DownloadIcon />
        CSV 내보내기
      </button>
      <a
        href="/templates/챙김_고객관리_통합양식.xlsx"
        download="챙김_고객관리_통합양식.xlsx"
        className="inline-flex items-center gap-1.5 h-9 px-4 rounded-lg bg-[var(--text-900)] hover:bg-black text-white text-[13px] font-semibold transition">
        <DocIcon />
        빈 양식 다운로드
      </a>
    </div>
...
function DownloadIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
      <path fillRule="evenodd" d="M10 3a.75.75 0 01.75.75v6.69l1.97-1.97a.75.75 0 111.06 1.06l-3.25 3.25a.75.75 0 01-1.06 0L6.22 9.53a.75.75 0 011.06-1.06l1.97 1.97V3.75A.75.75 0 0110 3z" clipRule="evenodd" />
